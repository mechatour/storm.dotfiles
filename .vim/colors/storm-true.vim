" Vim color file
" storm
" Created by Zane Godden with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#2c2c30"
let s:bg4="#404043"
let s:keyword="#707074"
let s:builtin="#cfcfd4"
let s:const= "#505064"
let s:comment="#505064"
let s:func="#505064"
let s:str="#e3e3e7"
let s:type="#e3e3e7"
let s:var="#e3e3e7"
let s:warning="#c46060"
let s:warning2="#c4c460"

exe 'hi Normal guifg='s:fg' guibg='s:bg
exe 'hi Cursor guifg='s:bg' guibg='s:fg
exe 'hi CursorLine term=NONE cterm=NONE guibg='s:bg2
exe 'hi CursorLineNr term=bold cterm=bold guifg='s:str' guibg='s:bg
